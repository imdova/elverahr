  ...
  return (
    <div className="flex flex-col items-center justify-center bg-white text-main h-screen">
      <div className="px-6 text-center">
        ...
        <Link
          href="/"
          className="inline-block text-white transform rounded-lg bg-primary px-8 py-3 text-lg font-semibold text-primary-foreground shadow-lg transition-all duration-300 hover:scale-105 hover:bg-primary-900">
          Go Back Home
        </Link>
      </div>
